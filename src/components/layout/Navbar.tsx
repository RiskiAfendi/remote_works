...
export default function Navbar({
  ...
  return (
    <nav className="glass-navbar fixed top-0 left-0 right-0 z-50 h-16 flex items-center justify-between px-4 md:px-6 relative border-b border-[var(--glass-border)] shadow-[var(--inner-highlight),0_4px_20px_rgba(0,0,0,0.1)]">
